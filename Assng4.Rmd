...
randomforest_model<-randomForest(status~., data=train_squared, mtry=7.745967, ntree=50)
randomforest_test <- predict(randomforest_model, newdata = test_squared, type= "class")
