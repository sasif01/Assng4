...
#lowest error =0.0434 with nbagg=200
set.seed(213)
...
#Tuning mtry(Number randomely variable selected is mtry)
...
print(paste0("ntree =", ntree, " | OOB error =", round(1 - rf_model$err.rate[ntree, "OOB"], 4)))

#highest accuracy at ntree=500 of 96.28%
set.seed(751)
...
randomforest_model<-randomForest(status~., data=train_squared, mtry=5, ntree=500)
randomforest_model
```
