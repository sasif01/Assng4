...
The training set is used to build a classification trees. The rpart function takes in a model with the status as the response and the 30 variables as predictors. 
